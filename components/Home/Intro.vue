<template>
  <div class="space-y-6">
    <NuxtImg src="/avatar.png" alt="Christian Augustyn"
    ...
    <p class="text-gray-900 dark:text-gray-400">
      I'm Christian, I work as an applications developer from
      Madang, Papua New Guinea. I specialize in building web applications and sites
...
useSeoMeta({
  ...
  description:
    "I'm Christian, your friendly neighborho an applications developer from Madang, Papua New Guinea. I specialize in building web applications and sites using Javascript, React, Vue & Node.",
});
</script>
